  ...
  return (
    <Modal open={ui.cartOpen} onClose={closeCart} label="Shopping bag" panelClassName="drawer-right" wrapperClassName="">
      <div className="flex items-center justify-between border-b hairline px-6 py-5">
        <h2 className="font-sans text-[12px] uppercase tracking-[0.28em] font-medium">Your Bag <span className="text-charcoal/50">({totals.count})</span></h2>
      ...
      {cartLines.length === 0 ? (
        ...
        <>
                ...
                <div className="flex flex-1 flex-col">
                  <div className="flex justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-[11px] uppercase tracking-[0.2em] text-charcoal/55">{sizeLabel(product)}</p>
                    </div>
                  ...
                  <div className="mt-auto flex items-center justify-between pt-4">
                    ...
                    <button type="button" onClick={() => removeFromCart(product.id)} className="link-line text-charcoal/60 hover:text-charcoal">Remove</button>
                  </div>
                </div>
              </li>
            ))}
          ...
          <div className="border-t hairline px-6 py-6">
            ...
            <p className="mt-1 text-[12px] text-charcoal/50">Taxes and delivery calculated at checkout.</p>
