            ...
            <div className="grid gap-14 lg:grid-cols-12">
                    ...
                    <div className="flex flex-col">
                      <div className="flex justify-between gap-4">
                        <div>
                          ...
                          <p className="mt-2 text-[12px] uppercase tracking-[0.2em] text-charcoal/55">{sizeLabel(product)} · {product.origin}</p>
                        </div>
              ...
              <aside className="lg:col-span-4">
                <div className="sticky top-[calc(var(--header-h)+32px)] border hairline p-7">
                  ...
                  <p className="mt-4 text-[12px] text-charcoal/55">{totals.subtotal >= FREE_SHIPPING_THRESHOLD ? 'White-glove delivery is included.' : `Complimentary white-glove delivery on orders over ${money(FREE_SHIPPING_THRESHOLD)}.`}</p>
